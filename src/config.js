export const CONFIG = {
  ...
  //
  // Уровни подняты под проверенную точку: тест по клавише T играет на 0.9,
  // и его слышно. Мурчание при полной громкости даёт 0.72 на слой — то есть
  // почти столько же, а не втрое тише, как было.
  PURR_VOLUME_DEEP: 0.8,
  PURR_VOLUME_BREATH: 0.7,
