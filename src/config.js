export const CONFIG = {
  ...
  PURR_FADE_IN: 800,
  PURR_FADE_OUT: 600,
  // 0.3 — под живую запись: она втрое громче синтезированной петли по RMS,
  // и прежние 0.8 задирали мурчание над фоном примерно на 20 дБ.
  PURR_VOLUME_DEEP: 0.3,
  // Ноль: нижний слой — живая запись мурчания, в ней дыхание уже есть,
  // и синтезированный слой поверх неё только мутит. Вернуть — поставить 0.3.
  PURR_VOLUME_BREATH: 0,
