...
function drawRoom(g, W) {
  ...
  const bedX = 1030;
  const bedR = 76; // половина ширины по внешнему краю
  const bedRim = 30; // высота бортика: приплюснутый клубочек всего 42
  // высотой, и над прежним бортиком от него торчала бы одна макушка
  const bedSeat = 12; // высота подстилки: на ней и лежит кот
